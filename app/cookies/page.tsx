    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container py-12 md:py-16">
        <div className="max-w-3xl mx-auto space-y-8">
          <h1 className="text-4xl font-bold tracking-tight text-center sm:text-5xl">Cookie Policy</h1>
          <p className="text-lg text-muted-foreground text-center">
            This Cookie Policy explains how DCA LMS ("Company," "we," "us," and "our") uses cookies and similar
            technologies to recognize you when you visit our websites at dcalms.com ("Websites"). It explains what these
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="mt-4 text-muted-foreground">
                Cookies set by the website owner (in this case, DCA LMS) are called "first-party cookies." Cookies set
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                We use first-party and third-party cookies for several reasons. Some cookies are required for our
                Websites to operate, and we refer to these as "essential" or "strictly necessary" cookies. Other cookies
                also enable us to track and target the interests of our users to enhance the experience on our Websites.
                Third parties serve cookies through our Websites for advertising, analytics, and other purposes. This is
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                ...
                has visited our Websites or opened an email including them. This allows us, for example, to monitor the
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Websites may also use "Flash Cookies" (also known as Local Shared Objects or "LSOs") to, among other
                things, collect and store information about your use of our services, fraud prevention, and for other
                site operations.
              </p>
              <p className="mt-4 text-muted-foreground">
                ...
                Cookies (referred to as "information" on the Macromedia site), how to prevent Flash LSOs from being
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                ...
                by them using cookies or web beacons to collect information about your visits to this and other websites
                in order to provide relevant advertisements about goods and services of potential interest to you. The
                information collected through this process does not enable us or them to identify your name, contact
                details or other personally identifiable details unless you choose to provide these.
              </p>
            </CardContent>
          </Card>
