...
export default function AICoursesPage() {
  ...
  const courses = [
    ...
    },
    {
      ...
      image: "/images/courses/machine-learning-basics.png",
      level: "Intermediate",
      price: "$59.99",
      tokenReward: 60,
      featured: false,
    },
    {
      ...
      image: "/images/courses/deep-learning-pytorch.png",
      level: "Advanced",
      price: "$89.99",
      tokenReward: 80,
      featured: false,
    },
    {
      ...
      description: "Master text analysis and language understanding",
      image: "/images/courses/natural-language-processing.png",
      level: "Intermediate",
      price: "$69.99",
      tokenReward: 65,
      featured: true,
    ...
    },
    {
      ...
      image: "/images/courses/ai-ethics.png",
      level: "Intermediate",
      price: "$49.99",
      tokenReward: 50,
      featured: false,
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto max-w-3xl mt-12 relative pl-8 before:absolute before:left-3 before:top-0 before:h-full before:w-0.5 before:bg-muted">
              ...
              <div className="mb-12 relative">
                ...
                <div className="flex gap-2">
                  <Link href="/courses/deep-learning-pytorch">
                    <Button variant="outline" size="sm">
                      View Course
                    </Button>
                  </Link>
              ...
              <div className="relative">
                ...
                <div className="flex gap-2">
                  <Link href="/courses/ai-applications">
                    <Button variant="outline" size="sm">
                      View Course
                    </Button>
                  </Link>
