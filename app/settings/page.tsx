...
import { Bell, Shield, Wallet, User, CreditCard, Eye, EyeOff } from "lucide-react"
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        },
                        {
                          ...
                          description: "Be the first to know about new learning materials",
                        },
                        {
                          key: "achievements",
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    {security.twoFactorEnabled && (
                      <Alert>
                        <AlertDescription>
                          Two-factor authentication is enabled. You'll need your authenticator app
                          to sign in.
                        </AlertDescription>
                      </Alert>
                    )}
            ...
            <TabsContent value="wallet">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Manage your Web3 wallet connections and blockchain preferences
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between rounded-lg border p-4">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">0x7a3b...f92e</p>
                          </div>
                        </div>
                    ...
                    <div className="rounded-lg border p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-sm text-muted-foreground">≈ $32.50</p>
                        </div>
                      </div>
                    </div>
                  </div>
